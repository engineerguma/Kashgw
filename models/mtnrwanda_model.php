...
//print_r($transactions);die();
     ...
     function CompletePendingTransactions($data,$log_name){
            ...
            //   print_r($data);die();
      //$this->log->LogToFile($vndr, "MtnrwandaModel::CompletePendingTransactions data ", 2, 3);
         $opco_response='';
        ...
        $this->log->LogRequest($log_name, "MtnrwandaModel::PrepareTOCloseTransaction closed transaction ".var_export($transact[0], true), 2, 3);
